<header class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    <div class="flex flex-col gap-2">
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b-2 border-slate-100 pb-8">
            ...
            <!-- <div class="hidden lg:flex items-center gap-6 border-l border-slate-200 pl-8">
                <div class="text-right">
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">System Load</p>
                    <p class="text-sm font-black text-slate-700">0.024ms</p>
                </div>
                <div class="text-right">
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Network</p>
    ...
    <div class="flex items-center gap-2 bg-white border rounded-xl p-1 shadow-sm">
        <a href="#traffic" class="flex items-center gap-2 px-5 py-2 text-sm font-bold rounded-xl transition-all duration-200 bg-blue-600 text-white shadow-lg shadow-blue-200/50 ring-1 ring-blue-700/10">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
            </svg>
            Traffic
        </a>
        <a href="#finance" class="flex items-center gap-2 px-5 py-2 text-sm font-semibold rounded-xl text-slate-600 hover:text-slate-900 hover:bg-white hover:shadow-sm transition-all duration-200">
